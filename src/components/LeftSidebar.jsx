...
import { Bookmark, Clock3, Globe2, MapPin } from 'lucide-react';

export default function LeftSidebar({ bookmarks, history, selectedCountry, onSelectCountry, onToggleBookmark }) {
  return (
    <aside className="hidden w-[320px] shrink-0 flex-col gap-4 lg:flex">
